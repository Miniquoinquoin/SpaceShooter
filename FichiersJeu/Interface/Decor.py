...
def display_coeur(x,y,taille,vie,vie_max):
    ...
    for i in range(int(35*taille/2/50),int(65*taille/2/50)+1,int(30*taille/2/50)):
        EZ.trace_disque(x+i,y+int(taille/2-taille/12.5),int(23*taille/2/50),int(-255/vie_max*vie+255),int(255/vie_max*vie),0)     
      
def info_vie(x,y,taille=50,vie=20,vie_max=20):
    """Trace icone de vie du joueur
    ...
    EZ.trace_rectangle_droit(x+19*taille/20,y+7*taille/20,taille*2.1,3*taille/10,50,50,50)
    #barre de vie à couleur changeante
    EZ.trace_rectangle_droit(x+39*taille/40,y+4*taille/10,taille*2,2*taille/10,30,30,30)
    EZ.trace_rectangle_droit(x+39*taille/40,y+4*taille/10,taille*2*vie/vie_max,2*taille/10,int(-255/vie_max*vie+255),int(255/vie_max*vie),0)
        



info_vie(00,00,100,157,200)
EZ.mise_a_jour()
EZ.attendre_action()
